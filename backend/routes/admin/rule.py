...
from services import AdminRuleService
...
def list_time_slots():
    ...
    result = AdminRuleService.list_time_slots(
...
def create_time_slot():
    ...
    result = AdminRuleService.save_time_slot(
...
def list_punch_geofences():
    ...
    include_deleted = parse_bool_arg('include_deleted', False)
    result = AdminRuleService.list_geofences(
...
def delete_punch_geofence(geofence_id):
    result = AdminRuleService.delete_geofence(geofence_id)
    return success(data=result)
...
def list_punch_rules():
    ...
    include_deleted = parse_bool_arg('include_deleted', False)
    result = AdminRuleService.list_punch_rules(
